                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                <div class="col-xs-12">${map.value.product.name}
                                </div>
                                <div class="col-xs-12"><small>Quantity:<span>${map.value.quantity}</span></small></div>
                            </div>
                            <div class="col-sm-3 col-xs-3 text-right">
                                <h6><span>$</span>${map.value.product.unitPrice*map.value.quantity}</h6>
                            </div>
                        </div>
                        </c:forEach>
...
<%--                        </div>--%>
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                <div class="pull-right"><span>$</span><span>${sessionScope.myCartToTal}</span></div>
                            </div>
                            <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                ...
                                <div class="pull-right"><span>$</span><span>${sessionScope.myCartToTal}</span>
<%--                                <form:hidden path="orderRequest.totalPrice" cssClass="form-control">${sessionScope.myCartToTal}</form:hidden>--%>
                                </div>
                            </div>
                        </div>
                    </div>
