...
<div class="container">
		<div class="head">
			<div class=" logo">
				<a href="index.jsp"><img src="<c:url value="/template/web/images/logo.png"/>" alt=""></a>
			</div>
		</div>
	</div>
		...
		<div class="content">
		   ...
		   <img src="<c:url value="/template/web/images/pi.jpg"/>" class="img-responsive" alt=""/><div class="b-wrapper1 long-img"><p class="b-animate b-from-right    b-delay03 ">Lorem ipsum</p><label class="b-animate b-from-right    b-delay03 "></label><h3 class="b-animate b-from-left    b-delay03 ">Trendy</h3></div></a>
					...
					<div class="col-md-6 col-md1">
						<div class="col-3">
							<a href="single.jsp"><img src="<c:url value="/template/web/images/pi1.jpg"/>" class="img-responsive" alt="">
							<div class="col-pic">
								<p>Lorem Ipsum</p>
								<label></label>
								<h5>For Men</h5>
						...
						<div class="col-3">
							<a href="single.jsp"><img src="<c:url value="/template/web/images/pi2.jpg"/>" class="img-responsive" alt="">
							<div class="col-pic">
								<p>Lorem Ipsum</p>
								<label></label>
								<h5>For Kids</h5>
						...
						<div class="col-3">
							<a href="single.jsp"><img src="<c:url value="/template/web/images/pi3.jpg"/>" class="img-responsive" alt="">
							<div class="col-pic">
								<p>Lorem Ipsum</p>
								<label></label>
								<h5>For Women</h5>
	...
	<div class="footer-middle">
				<div class="container">
					<div class="col-md-3 footer-middle-in">
						<a href="index.jsp"><img src="<c:url value="/template/web/images/log.png"/>" alt=""></a>
