...
<html>
<head>
<title>Shop Camera | Home :: w3layouts</title>
	...
	<!--content-->
		<div class="content">
			<div class="container">
				<div class="content-top">
					<div class="col-md-6 col-md">
						<div class="col-1">
						 <a href="<c:url value="/single"/>" class="b-link-stroke b-animate-go  thickbox">
		   <img src="<c:url value="/template/web/images/pi.jpg"/>" class="img-responsive" alt=""/><div class="b-wrapper1 long-img"><p class="b-animate b-from-right    b-delay03 ">Lorem ipsum</p><label class="b-animate b-from-right    b-delay03 "></label><h3 class="b-animate b-from-left    b-delay03 ">Trendy</h3></div></a>
						...
						<div class="col-2">
							<span>Hot Deal</span>
							<h2><a href="<c:url value="/single"/>">Luxurious &amp; Trendy</a></h2>
							<p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years</p>
							<a href="<c:url value="/single"/>" class="buy-now">Buy Now</a>
						</div>
					</div>
					<div class="col-md-6 col-md1">
						<div class="col-3">
							<a href="<c:url value="/single"/>"><img src="<c:url value="/template/web/images/pi1.jpg"/>" class="img-responsive" alt="">
							<div class="col-pic">
								<p>Lorem Ipsum</p>
								<label></label>
								<h5>For Men</h5>
						...
						<div class="col-3">
							<a href="<c:url value="/single"/>"><img src="<c:url value="/template/web/images/pi2.jpg"/>" class="img-responsive" alt="">
							<div class="col-pic">
								<p>Lorem Ipsum</p>
								<label></label>
								<h5>For Kids</h5>
						...
						<div class="col-3">
							<a href="<c:url value="/single"/>"><img src="<c:url value="/template/web/images/pi3.jpg"/>" class="img-responsive" alt="">
							<div class="col-pic">
								<p>Lorem Ipsum</p>
								<label></label>
								<h5>For Women</h5>
