                    ...
                    <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                        <ul class="nav navbar-nav nav_1">
                            ...
                            <li class="dropdown mega-dropdown active">
                                <a class="color1" href="#" class="dropdown-toggle" data-toggle="dropdown">Danh muc san pham<span class="caret"></span></a>
                            ...
                            <li><a class="color3" href="<c:url value="/sell_cameras/product"/>">Sale</a></li>
