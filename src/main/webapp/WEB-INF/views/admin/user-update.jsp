                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-validation">
                                <form:form class="form-valide" action="/admin/user/${id}" method="POST"
                                           modelAttribute="userRequest">
                                    <div class="form-group row">
                                        <label class="col-lg-4 col-form-label" for="val-userName">User name <span
                                                class="text-danger">* (can not change)</span>
                                        </label>
                                        <div class="col-lg-6">
                                            <input type="text" class="form-control" id="val-userName"
                                                   placeholder="Enter username.." value="${user.userName}" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <c:forEach items="${roles}" var="role">
                                        <c:if test="${user.roles.contains(role)}">
                                            <p>
                                                <input type="checkbox" class="check-box" name="ids" value="${role.id}"
